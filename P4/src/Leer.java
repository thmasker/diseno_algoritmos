...
//                sc.next();
            ...
            if (num < 0) {
                System.out.println("Error, introducce un n�mero entero positivo");
            }
    ...
    public int pedirIntRango(int minimo, int maximo) {
        ...
        do {
            try {
                System.out.println("Introduce un n�mero entero entre " + minimo + " y " + maximo);
                num = Integer.parseInt(sc.nextLine());
            } catch (NumberFormatException ex) {
                // En caso de error, el num se marca como un numero no valido
                num = maximo + 1;
//                sc.next();
            ...
            if (num < minimo || num > maximo) {
                System.out.println("Error, Introduce un n�mero entero entre " + minimo + " y " + maximo);
            }
    ...
    public char pedirChar() {
        ...
        System.out.println("Introduce un caracter (en caso de tener m�s de un caracter, se coger� el primero)");
